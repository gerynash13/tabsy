...
export async function GET(request: Request) {
  ...
  try {
    ...
    // Anything unexpected here (a bad Supabase query, a schema mismatch,
    // etc.) — log it clearly and return a real error response instead of
    // letting the function crash silently. Vercel's Logs tab captures
    // this console.error even without any extra monitoring service
    // wired up, which is enough visibility for this stage of the project.
    const message = err instanceof Error ? err.message : 'unknown error'
